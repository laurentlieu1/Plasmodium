...
#python omero_vgg19_trainable_tbnails3sickle.py --dataset /home/pmanescu/Data/thin/sickle_test/Train/ --csv_labels /home/pmanescu/Data/thin/sickle_test/sickle_slides.txt --test_dir /home/pmanescu/Data/thin/sickle_test/Test/ --test_csv_labels /home/pmanescu/Data/thin/sickle_test/sickle_slides.tx
...
parser.add_argument('--save_dir', dest='save_dir', default='C:/Users/molan/Downloads/Datasets/Algo/FASt-MAL-MOFF-master/FASt-MAL-MOFF-master/save', help='path to save the trained model')
parser.add_argument('--test_dir', dest='test_dir', default='C:/Users/molan/Downloads/Datasets/FASTMAL_THICK_FILMS/FASTMAL_THICK_FILMS', help='path to the test folder')
...
img1 = utils.load_image("C:/Users/molan/Downloads/Datasets/Algo/FASt-MAL-MOFF-master/FASt-MAL-MOFF-master/test/Im024_1.jpg")
...
with open(r"C:\Users\molan\Downloads\Datasets\Algo\FASt-MAL-MOFF-master\FASt-MAL-MOFF-master\code\__pycache__\test.csv", newline='') as csvfile:
...
with open("C:/Users/molan/Downloads/Datasets/Algo/FASt-MAL-MOFF-master/FASt-MAL-MOFF-master/labels_test.csv", newline='') as csvfile:
...
for subdir in subdirsAll: 
    predicted_rois = []
    slide_path = subdir#'/home/petre/mount_point/validation_data/355/'
    
    #print (slide_path.split(os.path.sep))
    #dataset_id = 
    #print(int(dataset_path.split(os.path.sep)[-1])
...
with tf.compat.v1.Session() as sess:
    ...
    true_out = tf.compat.v1.placeholder(tf.float32, [None, 2])
    train_mode = tf.compat.v1.placeholder(tf.bool)
    vgg = vgg19.Vgg19(imsize=64)
    #vgg = vgg19.Vgg19('../models/vgg19.npy', imsize=64)
    #vgg = vgg19.Vgg19("C:/Users/molan/Downloads/Datasets/Algo/FASt-MAL-MOFF-master/FASt-MAL-MOFF-master/moff_malaria_classifier_max_segmentation_vgg19_model.npy", imsize=64)
    ...
    for step in range(1, num_steps+1):
      try:  
          ...
          slides = utils.load_folder_random(selected_slides[sl_id], crop_size=64)
          ...
          if (step % 5000 == 0):   
            save_path = os.path.join(args.save_dir,'malaria_classifier1301_max_segmentation_ce'+str(step)+"_vgg19_model.npy")
...
# test classification again, should have a higher probability about tiger
    ...
    prediction_csv = 'malaria_prediction_max_segmentation1301ce.csv' 
    ...
    for tt in range(len(test_slides)):
        tslides = utils.load_folder_random(test_slides[tt], crop_size=64)
