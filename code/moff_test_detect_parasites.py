...
parser.add_argument('--trained_model', dest='trained_model', default="C:/Users/molan/Downloads/Datasets/Algo/FASt-MAL-MOFF-master/FASt-MAL-MOFF-master/moff_malaria_classifier_max_segmentation_vgg19_model.npy", help='path to slide images')
...
for index, file in enumerate(os.listdir("C:/Users/molan/Downloads/Datasets/FASTMAL_THICK_FILMS/FASTMAL_THICK_FILMS/355/")) :    
    test_img_path="C:/Users/molan/Downloads/Datasets/FASTMAL_THICK_FILMS/FASTMAL_THICK_FILMS/355/" + file # '/home/pmanescu/SkyNet/RawSplitDetectionData/test/398/FieldPos009_EDOF_RGB.tiff'            #
    ...
    with tf.compat.v1.Session() as sess:
        ...
        for c in centroids:
            ...
            ii+=1
        print(f"Parasite count : {count_parasite}")
        print(f"Distractor_count : {count_distractor}")
...
# test_img_path="C:/Users/molan/Downloads/Datasets/FASTMAL_THICK_FILMS/FASTMAL_THICK_FILMS/352/FieldPos003_EDOF_RGB.tiff"
# img = cv2.imread(test_img_path)
# csize=44
# tf.compat.v1.disable_v2_behavior()
# with tf.compat.v1.Session() as sess:
